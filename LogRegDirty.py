...
movieReviewModel = LogisticRegression(solver='liblinear', penalty='l1')
movieReviewModel.fit(X_train, Y_train)
pred = movieReviewModel.predict(X_test)

smsSpamModel = LogisticRegression(solver='liblinear', penalty='l1')
...
yelpModel = LogisticRegression(solver='liblinear', penalty='l1')
